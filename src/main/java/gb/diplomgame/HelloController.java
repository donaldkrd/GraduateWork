...
public class HelloController {
    ...
    void initialize() {
        ...
        bgOneTransition.setToX(BG_WITH * -1);
        ...
        bgTwoTransition.setToX(BG_WITH * -1);
        ...
        enemyTransition.setToX(BG_WITH * -1 -100);
